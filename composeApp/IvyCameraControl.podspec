Pod::Spec.new do |spec|
    ...
    if !Dir.exist?('build/cocoapods/framework/IvyCameraControl.framework') || Dir.empty?('build/cocoapods/framework/IvyCameraControl.framework')
        ...
        Kotlin framework 'IvyCameraControl' doesn't exist yet, so a proper Xcode project can't be generated.
    ...
    spec.pod_target_xcconfig = {
        ...
        'PRODUCT_MODULE_NAME' => 'IvyCameraControl',
    }
                
    spec.script_phases = [
        {
            :name => 'Build IvyCameraControl',
